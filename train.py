...
parser.add_argument('--dataset', default='cifar10', type=str, help='the name for dataset | cifar10 | cifar100 | tinyimagenet')
parser.add_argument('--dataroot', default='/data1/sm/', type=str, help='data directory')
...
parser.add_argument('--lamda', default=1.0, type=float, help='loss weight ratio')
parser.add_argument('--lamda2', default=1.0, type=float, help='loss weight ratio')
